...
const codeLines = [
  ...
  },
  {
    ...
    tone: "text-[#d7d9ff]",
    segments: [
      { text: "import", tone: "text-[#c792ea]" },
      { text: " ", tone: "text-[#d7d9ff]" },
      { text: "{", tone: "text-[#f78c6c]" },
      { text: " ", tone: "text-[#d7d9ff]" },
      { text: "Developer", tone: "text-[#82aaff]" },
      { text: " ", tone: "text-[#d7d9ff]" },
      { text: "}", tone: "text-[#f78c6c]" },
      { text: " ", tone: "text-[#d7d9ff]" },
  ...
  { id: "line-empty-1", text: "", tone: "text-[#d7d9ff]" },
  {
    ...
    tone: "text-[#d7d9ff]",
    segments: [
      { text: "const", tone: "text-[#c792ea]" },
      { text: " ", tone: "text-[#d7d9ff]" },
      { text: "Portfolio", tone: "text-[#82aaff]" },
      { text: " = ", tone: "text-[#d4d8f5]" },
  ...
  },
  {
    ...
    segments: [
      { text: "      ", tone: "text-[#d7d9ff]" },
      { text: "available", tone: "text-[#89ddff]" },
      { text: "=", tone: "text-[#d4d8f5]" },
      { text: "{", tone: "text-[#f78c6c]" },
      { text: "isAvailable", tone: "text-[#c3e88d]" },
      { text: "}", tone: "text-[#f78c6c]" }
