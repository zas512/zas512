...
export const experience = [
  {
    ...
    achievements: [
      "BeBalanced: Medical AI chatbot with RAG pipeline and session persistence",
      "JessiAI: Voice-enabled dementia care companion with WebSocket dashboard",
      "NexaMortgage: Rebuilt mortgage platform to URLA compliance with RAG chat",
      "SureHelp Insurance: Optimized database queries, reducing latency by 40%",
      "Purchase Portal: Built order engine and multi-level approval workflows",
      "SignWise Inbox: Unified mail inbox with live OAuth sync",
    ],
  },
  {
    company: "WJIKS",
    ...
    achievements: [
      "OSINT Platform: Real-time intelligence data viz dashboard for large datasets",
      "Adaptive Voice Dialer: WebRTC dialer supporting 100+ concurrent calls",
      "VoIP Billing: Multi-tenant VoIP billing with 99.9% uptime",
      "Jadops 3D GIS: Telemetry visualization built with CesiumJS",
    ],
  },
  {
    company: "Graana.com",
    ...
    achievements: [
      "Worksapp CRM: WebSocket CRM sync and React Native mobile dialer",
      "Call Center Backend: Contact center routing on FreePBX/Asterisk",
      "ARMS CRM Dialer: SIP client that reduced manual dialing by 60%",
    ],
  },
  {
    company: "Freelance",
    ...
    achievements: [
      "Siher.eth: Web3 site builder with IPFS Pinata storage",
      "Apply Pool: Conversational AI matches students to universities",
      "ReferPool: Peer job referral AI chatbot with memory persistence",
      "Beard Friends: Niche social platform scaled to 5,000+ active users",
      "Twinsting: Commission marketplace with escrow payment workflows",
      "Slick Magic AI: OpenAI + FFmpeg automated video creation SaaS",
    ],
  },
];
