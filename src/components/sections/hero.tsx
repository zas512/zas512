  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(0, 184, 232, 0.08), transparent 70%)"
        }}
  ...
  return (
    <div className="absolute inset-0 z-0 hidden lg:block pointer-events-none">
      ...
      <motion.div
        ...
        className="pointer-events-auto absolute left-[5%] top-[25%] w-68 hover:scale-102 hover:-rotate-3 transition-transform duration-300"
      >
      ...
      <motion.div
        ...
        className="pointer-events-auto absolute right-[6%] bottom-[25%] w-58 hover:scale-102 hover:rotate-3 transition-transform duration-300"
      >
