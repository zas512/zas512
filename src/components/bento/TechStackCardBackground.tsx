...
export function BentoTechStackCard() {
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      <p className="text-balance font-display tracking-wide text-xl w-full text-center text-zinc-100 md:text-3xl p-4">
      ...
      <div className="hidden lg:flex shrink-0 mx-6 flex-col overflow-hidden rounded-xl border border-white/10 bg-zinc-950/40 backdrop-blur-md transition-all duration-500 ease-out -bottom-4 absolute h-44">
        <div className="flex shrink-0 items-center gap-2 rounded-t-xl bg-line p-4">
          <span className="size-2 rounded-full bg-red-500/90" />
          <span className="size-2 rounded-full bg-yellow-500/90" />
          <span className="size-2 rounded-full bg-green-500/85" />
        </div>
        <p className="text-center leading-relaxed text-lg text-stone-300 p-6">
