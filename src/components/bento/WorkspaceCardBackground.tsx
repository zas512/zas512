...
export function WorkspaceCardBackground() {
  ...
  return (
    <div className="relative h-full p-6 space-y-6 flex flex-col items-center justify-center overflow-hidden">
      <p className="w-full text-center text-balance font-display text-xl leading-[1.02] text-zinc-100 md:text-[2rem]">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="rounded-full border border-cyan-300/30 bg-cyan-300/10 px-1.5 py-0.5 text-[9px] tracking-wide text-cyan-200 uppercase">
                    {logs[activeLog].tag}
                  </span>
                </div>
